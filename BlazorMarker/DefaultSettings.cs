...
namespace BlazorMarker
{
    public class DefaultSettings
    {
        ...
        [JsonPropertyName("newFreehandMarkerOnPointerUp")]
        public bool NewFreehandMarkerOnPointerUp { get; set; } = false;

        [JsonPropertyName("popupMargin")]
        public int PopupMargin { get; set; } = 30;

        [JsonPropertyName("freehandPixelRatio")]
        public int FreehandPixelRatio { get; set; } = 1;

        [JsonPropertyName("disableRotation")]
        public bool DisableRotation { get; set; } = false;

        [JsonPropertyName("uiOffsetTop")]
        public int UiOffsetTop { get; set; } = 0;
    }
}
